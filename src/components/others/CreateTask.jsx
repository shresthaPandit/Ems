...
const CreateTask = () => {
  ...
  const submitHandler = (e) => {
    ...
    const updatedData = [...userData]; // Make a copy of the current user data
    ...
    localStorage.setItem('employees', JSON.stringify(updatedData)); // Persist the updated data to localStorage
